...
import VerticalLogo from '@/components/ver-logo'
import SubMarkLogo from '@/components/submark-logo'
...
<ColorPalette colors={[
    {title:'Primary',value:'--primary', description: 'Olive leaf · Strength · Growth', className:'bg-primary text-primary-foreground'}, 
    {title:'Accent',value:'--accent', description: 'Verdant bloom · Emphasis · Energy', className:'bg-accent text-accent-foreground'},
    {title:'Secondary',value:'--secondary', description: 'Morning fog · Balance · Softness', className:'bg-secondary text-secondary-foreground'},
    {title:'Muted',value:'--muted', description: 'Whispered tone · Subtle · Clarity', className:'bg-muted text-muted-foreground'},
    {title:'Foreground',value:'--foreground', description: 'Leaf vein · Depth · Focus', className:'bg-foreground text-background'}]}/>
